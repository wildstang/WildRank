...
if (localStorage.getItem('config-settings') !== null)
{
    localStorage.clear()
    location.reload()
}
...
function trigger_install_warning()
{
    ...
    if (browser !== 'Firefox' && get_display_mode() !== 'standalone' && sessionStorage.getItem('dismiss_warning') !== 'true' && !page.startsWith('misc/'))
    {
