...
function init_page()
{
    ...
    if (dal.team_numbers.length > 0)
    {
        ...
        let importer = build_import_picklist(build_pick_lists)
        let export_button = new WRMultiButton('', ['Import', 'Export'], [importer.step_import.bind(importer), export_picklists])
