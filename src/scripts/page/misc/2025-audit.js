...
function init_page()
{
    ...
    add_option(new WRMatchOption('summary', 'Summary', [], []))
...
function add_match(match)
{
    ...
    // get TBA match data
    let match_data = JSON.parse(localStorage.getItem(`matches-${dal.event_id}`))
    if (match_data === null)
    {
        return
    }

    let score_breakdown = match_data.filter(m => m.key === match)[0].score_breakdown
    let red_breakdown = score_breakdown['red']
    let blue_breakdown = score_breakdown['blue']
    ...
    {
        red_proc += dal.get_match_value(match, team, 'result.match_auto_algae_scoring_algae_processor') + dal.get_match_value(match, team, 'result.match_tele_op_algae_scoring_algae_processor')
        red_net += dal.get_match_value(match, team, 'result.match_auto_algae_scoring_algae_net') + dal.get_match_value(match, team, 'result.match_tele_op_algae_scoring_algae_net')
        red_auto_l1 += dal.get_match_value(match, team, 'result.match_auto_coral_scoring_level_scored_level_1')
        red_auto_l23 += dal.get_match_value(match, team, 'result.match_auto_coral_scoring_level_scored_level_23')
        red_auto_l4 += dal.get_match_value(match, team, 'result.match_auto_coral_scoring_level_scored_level_4')
        red_tele_l1 += dal.get_match_value(match, team, 'result.match_tele_op_coral_scoring_level_scored_level_1')
        red_tele_l23 += dal.get_match_value(match, team, 'result.match_tele_op_coral_scoring_level_scored_level_23')
        red_tele_l4 += dal.get_match_value(match, team, 'result.match_tele_op_coral_scoring_level_scored_level_4')
    }
    ...
    {
        blue_proc += dal.get_match_value(match, team, 'result.match_auto_algae_scoring_algae_processor') + dal.get_match_value(match, team, 'result.match_tele_op_algae_scoring_algae_processor')
        blue_net += dal.get_match_value(match, team, 'result.match_auto_algae_scoring_algae_net') + dal.get_match_value(match, team, 'result.match_tele_op_algae_scoring_algae_net')
        blue_auto_l1 += dal.get_match_value(match, team, 'result.match_auto_coral_scoring_level_scored_level_1')
        blue_auto_l23 += dal.get_match_value(match, team, 'result.match_auto_coral_scoring_level_scored_level_23')
        blue_auto_l4 += dal.get_match_value(match, team, 'result.match_auto_coral_scoring_level_scored_level_4')
        blue_tele_l1 += dal.get_match_value(match, team, 'result.match_tele_op_coral_scoring_level_scored_level_1')
        blue_tele_l23 += dal.get_match_value(match, team, 'result.match_tele_op_coral_scoring_level_scored_level_23')
        blue_tele_l4 += dal.get_match_value(match, team, 'result.match_tele_op_coral_scoring_level_scored_level_4')
    }
    ...
    for (let team of red_alliance)
    {
        let scouted = dal.get_match_value(match, team, 'result.match_auto_movement_leave')
    ...
    let climb_ops = cfg.get_result_from_key('result.match_tele_op_endgame_barge_scoring').options
    for (let team of red_alliance)
    {
        let scouted_climb = climb_ops[dal.get_match_value(match, team, 'result.match_tele_op_endgame_barge_scoring')]
        ...
        let id = dal.get_match_meta(match, team, 'match')[0].scouter.user_id.toString()
