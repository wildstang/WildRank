...
function open_option(match_num)
{
    ...
    if (scout_mode === MATCH_MODE)
    {
        ...
        let scout_button = new WRLinkButton('Scout Match', build_url('scout', {type: MATCH_MODE, match: key, team: team_num, alliance: alliance, edit: false}))
        ...
        if (dal.is_match_scouted(match_num, team_num))
        {
            ...
            {
                let edit_button = new WRLinkButton('Edit Match', build_url('scout', {type: MATCH_MODE, match: key, team: team_num, alliance: alliance, edit: true}))
    ...
    else if (scout_mode === NOTE_MODE)
    {
        ...
        // build buttons
        let key = match_num.toLowerCase()
        let scout_button = new WRLinkButton('Take Notes', build_url('note', {match: key, alliance: alliance, edit: false}))
        buttons.append(scout_button)
        ...
        if (dal.is_note_scouted(match_num, team_num))
        {
            ...
            if (can_edit(match_num, team_num))
            {
                let edit_button = new WRLinkButton('Edit Notes', build_url('note', {match: key, alliance: alliance, edit: true}))
                edit_button.add_class('slim')
                page.add_column(new WRColumn('', [edit_button]))
