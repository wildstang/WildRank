...
const CACHE_LIST = [
    ...
    '/scripts/pages/bracket.js',
    '/scripts/pages/cache.js',
    '/scripts/pages/coach.js',
    '/scripts/pages/config-debug.js',
    '/scripts/pages/config-generator.js',
    '/scripts/pages/custom-match.js',
    '/scripts/pages/cycles.js',
    '/scripts/pages/distro.js',
    '/scripts/pages/edit-coach.js',
    '/scripts/pages/edit-stats.js',
    '/scripts/pages/event-generator.js',
    '/scripts/pages/events.js',
    '/scripts/pages/export.js',
    '/scripts/pages/home.js',
    '/scripts/pages/match-overview.js',
    '/scripts/pages/matches.js',
    '/scripts/pages/multipicklists.js',
    '/scripts/pages/note.js',
    '/scripts/pages/note-viewer.js',
    '/scripts/pages/pits.js',
    '/scripts/pages/pivot.js',
    '/scripts/pages/plot.js',
    '/scripts/pages/progress.js',
    '/scripts/pages/random.js',
    '/scripts/pages/ranker.js',
    '/scripts/pages/results.js',
    '/scripts/pages/scatter.js',
    '/scripts/pages/schedule-importer.js',
    '/scripts/pages/scout.js',
    '/scripts/pages/scouter-scheduler.js',
    '/scripts/pages/settings.js',
    '/scripts/pages/setup.js',
    '/scripts/pages/sides.js',
    '/scripts/pages/storage.js',
    '/scripts/pages/teams.js',
    '/scripts/pages/transfer-raw.js',
    '/scripts/pages/whiteboard.js',
    '/scripts/users.js',
    '/scripts/blank.js',
    ...
    '/scripts/pages/misc/2022-score-estimator.js',
    '/scripts/pages/misc/2023-score-estimator.js',
    '/scripts/pages/misc/district-counter.js',
    '/scripts/pages/misc/event-planner.js',
    '/scripts/pages/misc/international-counter.js',
    '/scripts/pages/misc/match-counter.js',
    '/scripts/pages/misc/revival-counter.js',
    '/scripts/pages/misc/score-counter.js',
    '/scripts/pages/misc/team-profile.js',*/
    '/scripts/pages/misc/2025-score-calculator.js',
    '/scripts/pages/misc/test.js',
    // assets
